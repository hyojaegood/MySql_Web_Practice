			...
			<div class="header">
				<div class="cssmenu">
					<ul>
						...
						<li class="has-sub"><a href="./service.do">먹거리 정보</a></li>
				...
				<div class="search">
					<form id="_fosearch" action="<%=request.getContextPath()%>/service.do" method="post">
							...
							<div class="grid_1_of_3 images_1_of_3">
								...
								<div class="g">
									...
									<div class="rd_more" align="right">
										<form action="<%=request.getContextPath()%>/detail.do" method="post"  class='_fo2'>
