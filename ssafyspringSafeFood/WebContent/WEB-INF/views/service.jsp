			...
			<div class="header">
				<div class="cssmenu">
					<ul>
						...
						<li class="active" class="has-sub"><a href="./service.do">먹거리
								정보</a></li>
				...
				<div class="search">
					<form id="_fosearch" action="<%=request.getContextPath()%>/service.do"
						method="post">
						...
						<c:forEach items="${foods}" var="food" varStatus="vs">
							<div class="special-grids">
								...
								<div class="rd_more" align="right">
									<form action="<%=request.getContextPath()%>/detail.do"
